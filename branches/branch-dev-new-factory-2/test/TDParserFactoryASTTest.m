...
//    PKAST *rootNode = [_factory ASTFromGrammar:g simplify:NO error:&err];
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:SEQ (:SEQ :Word :Number))))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start (foo (bar (| baz bat))))", [rootNode treeDescription]);
//}
//
//
...
//    PKAST *rootNode = [_factory ASTFromGrammar:g simplify:NO error:&err];
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:SEQ (:| :Word (:SEQ :Number :Symbol)))))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start:SEQ (foo:| :Word (:SEQ :Number :Symbol)))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start (foo (bar (| baz bat))))", [rootNode treeDescription]);
//}
//
...
//    PKAST *rootNode = [_factory ASTFromGrammar:g simplify:NO error:&err];
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:| :Word (:SEQ (:SEQ :Number :Symbol)))))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start:SEQ (foo:| :Word (:SEQ :Number :Symbol)))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start (foo (bar (| baz bat))))", [rootNode treeDescription]);
//}
//
...
//    PKAST *rootNode = [_factory ASTFromGrammar:g simplify:NO error:&err];
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:SEQ (:SEQ :QuotedString :Number))))", [rootNode treeDescription]);
//    //TDEqualObjects(@"(@start:SEQ (foo:SEQ :QuotedString :Number))", [rootNode treeDescription]);
//    
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF (:* (:SEQ :Number))))", [rootNode treeDescription]);
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF (:~ (:SEQ (:SEQ :Word :Number)))))", [rootNode treeDescription]);
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF (:SEQ (:* (:SEQ (:| :Word :Number))) :QuotedString)))", [rootNode treeDescription]);
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:SEQ (:* (:SEQ (:| :Word :Number))) :QuotedString)))", [rootNode treeDescription]);
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF foo:REF) (foo:DEF (:SEQ (:* (:SEQ (:| :Word :Number))) :QuotedString :Symbol)))", [rootNode treeDescription]);
//    //    TDEqualObjects(@"(@start (foo (* (| Word Number)) QuotedString))"), [rootNode treeDescription]);
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF (:+ (:SEQ (:SEQ '$' '%')))))", [rootNode treeDescription]);
////    TDEqualObjects(@"(@start:+ (:SEQ :'$' :'%'))", [rootNode treeDescription]);
//}
//
//
...
//    
//    TDNotNil(rootNode);
//    TDEqualObjects(@"(ROOT (@start:DEF (:SEQ (:SEQ (:| (:* (:| :Word :Number)) (:SEQ (:SEQ '$' '%')))) (:+ :QuotedString))))", [rootNode treeDescription]);
