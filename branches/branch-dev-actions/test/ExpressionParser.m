...
- (void)relExpr {
    ...
    [self callExpr]; 
    while (LA(1) == TOKEN_KIND_GE || LA(1) == TOKEN_KIND_LE || LA(1) == TOKEN_KIND_GT || LA(1) == TOKEN_KIND_NE || LA(1) == TOKEN_KIND_LT || LA(1) == TOKEN_KIND_EQ) {
...
- (void)callExpr {
    ...
    [self primary]; 
    if ((LA(1) == TOKEN_KIND_OPENPAREN) && ([self speculate:^{ [self openParen]; if ((LA(1) == TOKEN_KIND_BUILTIN_QUOTEDSTRING || LA(1) == TOKEN_KIND_YES || LA(1) == TOKEN_KIND_NO || LA(1) == TOKEN_KIND_BUILTIN_NUMBER || LA(1) == TOKEN_KIND_BUILTIN_WORD) && ([self speculate:^{ [self argList]; }])) {[self argList]; }[self closeParen]; }])) {
        [self openParen]; 
        if ((LA(1) == TOKEN_KIND_BUILTIN_QUOTEDSTRING || LA(1) == TOKEN_KIND_YES || LA(1) == TOKEN_KIND_NO || LA(1) == TOKEN_KIND_BUILTIN_NUMBER || LA(1) == TOKEN_KIND_BUILTIN_WORD) && ([self speculate:^{ [self argList]; }])) {
            [self argList]; 
        }
        [self closeParen]; 
    }
