...
- (void)relExpr {
    ...
    [self callExpr]; 
    while (LA(1) == TOKEN_KIND_NE || LA(1) == TOKEN_KIND_LT || LA(1) == TOKEN_KIND_GE || LA(1) == TOKEN_KIND_LE || LA(1) == TOKEN_KIND_GT || LA(1) == TOKEN_KIND_EQ) {
        [self relOp]; 
        [self callExpr]; 
    }
...
- (void)callExpr {
    ...
    if (LA(1) == TOKEN_KIND_OPENPAREN) {
        [self openParen]; 
        if (LA(1) == TOKEN_KIND_BUILTIN_QUOTEDSTRING || LA(1) == TOKEN_KIND_NO || LA(1) == TOKEN_KIND_BUILTIN_NUMBER || LA(1) == TOKEN_KIND_YES || LA(1) == TOKEN_KIND_BUILTIN_WORD) {
            [self argList]; 
        }
        [self closeParen]; 
    }
...
- (void)atom {
    ...
    if (LA(1) == TOKEN_KIND_BUILTIN_WORD) {
        [self obj]; 
    } else if (LA(1) == TOKEN_KIND_NO || LA(1) == TOKEN_KIND_BUILTIN_NUMBER || LA(1) == TOKEN_KIND_YES || LA(1) == TOKEN_KIND_BUILTIN_QUOTEDSTRING) {
        [self literal]; 
    } else {
