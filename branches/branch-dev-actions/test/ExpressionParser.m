...
- (void)relExpr {
    ...
    [self callExpr]; 
    while (LA(1) == TOKEN_KIND_EQ || LA(1) == TOKEN_KIND_LT || LA(1) == TOKEN_KIND_GT || LA(1) == TOKEN_KIND_LE || LA(1) == TOKEN_KIND_GE || LA(1) == TOKEN_KIND_NE) {
...
- (void)callExpr {
    ...
    if (LA(1) == TOKEN_KIND_OPENPAREN) {
        [self openParen]; 
        if (LA(1) == TOKEN_KIND_BUILTIN_WORD || LA(1) == TOKEN_KIND_NO || LA(1) == TOKEN_KIND_BUILTIN_QUOTEDSTRING || LA(1) == TOKEN_KIND_YES || LA(1) == TOKEN_KIND_BUILTIN_NUMBER) {
            [self argList]; 
        }
        [self closeParen]; 
    }
