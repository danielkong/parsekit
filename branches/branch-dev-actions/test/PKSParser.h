...
enum {
    ...
    TOKEN_KIND_BUILTIN_LOWERCASEWORD = 5,
    TOKEN_KIND_BUILTIN_UPPERCASEWORD = 6,
    TOKEN_KIND_BUILTIN_WHITESPACE = 7,
    TOKEN_KIND_BUILTIN_COMMENT = 8,
    TOKEN_KIND_BUILTIN_DELIMITEDSTRING = 9,
    TOKEN_KIND_BUILTIN_URL = 10,
    TOKEN_KIND_BUILTIN_EMAIL = 11,
    TOKEN_KIND_BUILTIN_TWITTER = 12,
    TOKEN_KIND_BUILTIN_HASHTAG = 13,
    TOKEN_KIND_BUILTIN_EMPTY = 14,
    TOKEN_KIND_BUILTIN_ANY = 15,
};
