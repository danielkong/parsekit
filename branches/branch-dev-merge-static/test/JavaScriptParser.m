...
- (void)_start {
	...
	[self._tokenizer setTokenizerState:self._tokenizer.commentState from:'/' to:'/'];
	[self._tokenizer.commentState addSingleLineStartMarker:@"//"];
	[self._tokenizer.commentState addMultiLineStartMarker:@"/*" endMarker:@"*/"];
