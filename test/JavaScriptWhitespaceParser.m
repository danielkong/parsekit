...
- (void)falseLiteral {
    ...
    [self match:JAVASCRIPTWHITESPACE_TOKEN_KIND_FALSELITERAL discard:NO]; 
...
- (void)trueLiteral {
    ...
    [self match:JAVASCRIPTWHITESPACE_TOKEN_KIND_TRUELITERAL discard:NO]; 
...
- (void)element {
    ...
    if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_FUNCTION, 0]) {
        [self func]; 
    } else if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_BREAKSYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_CONTINUESYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_DELETE, JAVASCRIPTWHITESPACE_TOKEN_KIND_FALSELITERAL, JAVASCRIPTWHITESPACE_TOKEN_KIND_FORSYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_IFSYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_KEYWORDNEW, JAVASCRIPTWHITESPACE_TOKEN_KIND_MINUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_MINUSMINUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_NULL, JAVASCRIPTWHITESPACE_TOKEN_KIND_OPENCURLY, JAVASCRIPTWHITESPACE_TOKEN_KIND_OPENPAREN, JAVASCRIPTWHITESPACE_TOKEN_KIND_PLUSPLUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_RETURNSYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_SEMI, JAVASCRIPTWHITESPACE_TOKEN_KIND_THIS, JAVASCRIPTWHITESPACE_TOKEN_KIND_TILDE, JAVASCRIPTWHITESPACE_TOKEN_KIND_TRUELITERAL, JAVASCRIPTWHITESPACE_TOKEN_KIND_TYPEOF, JAVASCRIPTWHITESPACE_TOKEN_KIND_UNDEFINED, JAVASCRIPTWHITESPACE_TOKEN_KIND_VAR, JAVASCRIPTWHITESPACE_TOKEN_KIND_VOID, JAVASCRIPTWHITESPACE_TOKEN_KIND_WHILESYM, JAVASCRIPTWHITESPACE_TOKEN_KIND_WITH, TOKEN_KIND_BUILTIN_NUMBER, TOKEN_KIND_BUILTIN_QUOTEDSTRING, TOKEN_KIND_BUILTIN_WORD, 0]) {
        [self stmt]; 
    } else {
...
- (void)variablesOrExpr {
    ...
    if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_VAR, 0]) {
        [self varVariables]; 
    } else if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_DELETE, JAVASCRIPTWHITESPACE_TOKEN_KIND_FALSELITERAL, JAVASCRIPTWHITESPACE_TOKEN_KIND_KEYWORDNEW, JAVASCRIPTWHITESPACE_TOKEN_KIND_MINUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_MINUSMINUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_NULL, JAVASCRIPTWHITESPACE_TOKEN_KIND_OPENPAREN, JAVASCRIPTWHITESPACE_TOKEN_KIND_PLUSPLUS, JAVASCRIPTWHITESPACE_TOKEN_KIND_THIS, JAVASCRIPTWHITESPACE_TOKEN_KIND_TILDE, JAVASCRIPTWHITESPACE_TOKEN_KIND_TRUELITERAL, JAVASCRIPTWHITESPACE_TOKEN_KIND_TYPEOF, JAVASCRIPTWHITESPACE_TOKEN_KIND_UNDEFINED, JAVASCRIPTWHITESPACE_TOKEN_KIND_VOID, TOKEN_KIND_BUILTIN_NUMBER, TOKEN_KIND_BUILTIN_QUOTEDSTRING, TOKEN_KIND_BUILTIN_WORD, 0]) {
        [self expr]; 
    } else {
...
- (void)primaryExpr {
    ...
    if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_KEYWORDNEW, 0]) {
        ...
        [self stringLiteral]; 
    } else if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_FALSELITERAL, 0]) {
        [self falseLiteral]; 
    } else if ([self predicts:JAVASCRIPTWHITESPACE_TOKEN_KIND_TRUELITERAL, 0]) {
        [self trueLiteral]; 
