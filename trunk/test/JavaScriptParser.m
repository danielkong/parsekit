...
- (id)init {
    ...
    if (self) {
        ...
        self.tokenKindTab[@"false"] = @(JAVASCRIPT_TOKEN_KIND_FALSELITERAL);
        ...
        self.tokenKindTab[@"true"] = @(JAVASCRIPT_TOKEN_KIND_TRUELITERAL);
        ...
        self.tokenKindNameTab[JAVASCRIPT_TOKEN_KIND_FALSELITERAL] = @"false";
        ...
        self.tokenKindNameTab[JAVASCRIPT_TOKEN_KIND_TRUELITERAL] = @"true";
